...
export async function compareGolden(options) {
...
export function normalizeFixture(raw, format, config) {
...
function buildResult(status, options, format, changed, diff) {
...
async function readGolden(goldenPath) {
    try {
...
function resolveFormat(format, actualPath) {
    if (format !== 'auto') {
        return format;
    }
